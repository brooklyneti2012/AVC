...
namespace AvUni.Controllers
{
    public class OrderProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderProductID,ProductCategory,ProductID,OrderID")] OrderProduct orderProduct)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderProductID,ProductCategory,ProductID,OrderID")] OrderProduct orderProduct)
        {
